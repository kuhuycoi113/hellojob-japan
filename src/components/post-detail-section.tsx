                ...
                <CardContent>
                    <div className="space-y-4">
                        <div className="space-y-1.5">
                            <Label htmlFor="comment" className="sr-only">{t.postDetail.commentForm.comment.label}</Label>
                            <Textarea id="comment" placeholder={t.postDetail.commentForm.comment.placeholder} rows={3} />
                        </div>
                    ...
                    <Link href="#" key={index}>
                      <div className="group flex items-start gap-4 hover:bg-gray-50 p-2 rounded-lg transition-colors">
                        ...
                        <div className="flex-1">
                          ...
                          <h4 className="font-semibold text-sm leading-snug group-hover:text-primary transition-colors">{item.title}</h4>
                        </div>
                      </div>
                    </Link>
                  ))}
